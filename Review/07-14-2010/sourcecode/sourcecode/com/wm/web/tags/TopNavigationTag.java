...
/**
 * Displays the top navigation that is displayed on the web pages.  It is dependent on the 
 ...
 *
 */
public class TopNavigationTag extends NavigationTag  {
	...
	@Override
  	public void doTag() throws JspException, IOException {
        ...
        try {
          		...
          		File xsltFile = new File(filePath + "/layout/xslt/topnavigation.xslt");
